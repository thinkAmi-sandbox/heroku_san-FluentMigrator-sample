...
LOCAL_RUNNER = 'packages\FluentMigrator.Tools.1.4.0.0\tools\AnyCPU\40\Migrate.exe'
LOCAL_TARGET = 'heroku_san-FluentMigrator-sample\bin\Debug\heroku_san-FluentMigrator-sample.exe'
